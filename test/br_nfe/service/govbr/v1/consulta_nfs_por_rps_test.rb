...
describe BrNfe::Service::Govbr::V1::ConsultaNfsPorRps do
	subject             { FactoryGirl.build(:service_govbr_v1_consulta_nfs_por_rps, emitente: emitente) }
	...
	# 	before do 
	# 		savon.mock!
	# 		stub_request(:get, subject.wsdl).to_return(status: 200, body: read_fixture('service/wsdl/govbr/v1/nfseservice.xml') )
	# 	end
	# 	after  { savon.unmock! }

	# 	it "Quando a requisição voltar com erro deve setar os erros corretamente" do
	# 		fixture = read_fixture('service/response/govbr/v1/consulta_nfse_por_rps/fault.xml')
	...
	# 		fixture = read_fixture('service/response/govbr/v1/consulta_nfse_por_rps/nfse_simple.xml')
	# 		savon.expects(:consultar_nfse_por_rps).returns(fixture)
	# 		subject.request
	# 		response = subject.response
	...
	# 		fixture = read_fixture('service/response/govbr/v1/consulta_nfse_por_rps/nfse_complete.xml')
	# 		savon.expects(:consultar_nfse_por_rps).returns(fixture)
	# 		subject.request
	# 		response = subject.response
