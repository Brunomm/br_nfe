...
describe BrNfe::Service::Betha::V1::ConsultaLoteRps do
	...
	describe "#request and set response" do
		...
		it "Quando a requisição voltar com erro deve setar os erros corretamente" do
			fixture = File.read(BrNfe.root+'/test/fixtures/service/response/betha/v1/consulta_lote_rps/fault.xml')
		...
		it "Quando encontrar uma nota fiscal com as informações preenchidas" do
			fixture = File.read(BrNfe.root+'/test/fixtures/service/response/betha/v1/consulta_lote_rps/success.xml')
			savon.expects(:consultar_lote_rps_envio).returns(fixture)
			subject.request
			response = subject.response
			...
			nf.total_services.must_equal '349'
			nf.iss_retained.must_equal '2'
			nf.total_iss.must_equal '0'
			nf.base_calculation.must_equal '349'
