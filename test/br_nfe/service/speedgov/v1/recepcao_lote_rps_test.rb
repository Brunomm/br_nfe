...
describe BrNfe::Service::Speedgov::V1::RecepcaoLoteRps do
	subject        { FactoryGirl.build(:service_speedgov_v1_recepcao_lote_rps, emitente: emitente) }
	...
	describe "Validação do XML através do XSD" do
		...
		def validate_schema
			Dir.chdir(schemas_dir) do
				schema = Nokogiri::XML::Schema(IO.read('enviar_lote_rps_envio_v1.xsd'))
	...
	# 		fixture = read_fixture('service/response/speedgov/v1/recepcao_lote_rps/success.xml')
	...
	# 		fixture = read_fixture('service/response/speedgov/v1/recepcao_lote_rps/error.xml')
