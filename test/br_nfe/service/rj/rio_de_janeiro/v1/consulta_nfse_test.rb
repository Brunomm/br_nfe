...
describe BrNfe::Service::RJ::RioDeJaneiro::V1::ConsultaNfse do
	subject             { FactoryGirl.build(:service_rj_rj_v1_consulta_nfse, emitente: emitente) }
	...
	it "#soap_body_root_tag" do
		subject.soap_body_root_tag.must_equal 'ConsultarNfseRequest'
	end
	...
	describe "#request and set response" do
		...
		it "Se não encontrar nenhuma NFe" do
			fixture = read_fixture('service/response/rj/rio_de_janeiro/v1/consulta_nfse/nfs_empty.xml')
		...
		it "Quando a requisição voltar com erro deve setar os erros corretamente" do
			fixture = read_fixture('service/response/rj/rio_de_janeiro/v1/consulta_nfse/fault.xml')
		...
		it "Quando encontrar uma nota fiscal com as informações básicas preenchidas" do
			fixture = read_fixture('service/response/rj/rio_de_janeiro/v1/consulta_nfse/nfse_simple.xml')
			savon.expects(:consultar_nfse).returns(fixture)
			subject.request
			response = subject.response
		...
		it "Quando encontrar uma nota fiscal com as informações completas" do
			fixture = read_fixture('service/response/rj/rio_de_janeiro/v1/consulta_nfse/nfse_complete.xml')
			savon.expects(:consultar_nfse).returns(fixture)
			subject.request
			response = subject.response
