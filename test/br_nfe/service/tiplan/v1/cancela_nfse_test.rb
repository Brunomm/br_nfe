...
describe BrNfe::Service::Tiplan::V1::CancelaNfse do
	subject             { FactoryGirl.build(:service_tiplan_v1_cancela_nfse, emitente: emitente) }
	...
	# 		fixture = read_fixture('service/response/tiplan/v1/cancela_nfse/success.xml')
	...
	# 		fixture = read_fixture('service/response/tiplan/v1/cancela_nfse/fault.xml')
