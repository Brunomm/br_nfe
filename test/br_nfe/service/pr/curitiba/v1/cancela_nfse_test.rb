...
describe BrNfe::Service::PR::Curitiba::V1::CancelaNfse do
	subject             { FactoryGirl.build(:service_pr_curitiba_v1_cancela_nfse, emitente: emitente) }
	...
	# 		fixture = read_fixture('service/response/pr/curitiba/v1/cancela_nfse/success.xml')
	...
	# 		fixture = read_fixture('service/response/pr/curitiba/v1/cancela_nfse/fault.xml')
