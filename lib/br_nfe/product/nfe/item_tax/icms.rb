		...
		module Nfe
			module ItemTax
				class Icms < BrNfe::ActiveModelBase
					...
					#
					# <b>Type:     </b> _Float_
					# <b>Required: </b> _NO_ Yes if have CFP
					# <b>Example:  </b> _75.5_
					# <b>Length:   </b> _13v2_
					# <b>tag:      </b> vBCFCP
					#
					attr_accessor :cfp_base_calculo
					alias_attribute :vBCFCP, :cfp_base_calculo

					# PERCENTUAL DO FUNDO DE COMBATE À POBREZA
					#
					# CSTs: 00, 10, 20, 51, 70, 90
					#
					# <b>Type:     </b> _Float_
					# <b>Required: </b> _NO_ Yes if have CFP
					# <b>Example:  </b> _75.5_
					...
					# <b>tag:      </b> pFCP
					#
					attr_accessor :cfp_percentual
					alias_attribute :pFCP, :cfp_percentual
					...
					# <b>tag:      </b> vFCP
					#
					attr_accessor :cfp_valor
					alias_attribute :vFCP, :cfp_valor

					# VALOR DA BASE DE CÁLCULO DO FCP RETIDO POR SUBSTITUIÇÃO TRIBUTÁRIA
					#
					# CSTs: 10, 30, 70, 90, 201, 202, 203, 900
					#
					# <b>Type:     </b> _Float_
					# <b>Required: </b> _NO_ Yes if have CFP
					# <b>Example:  </b> _75.5_
					...
					# <b>tag:      </b> vBCFCPST
					#
					attr_accessor :cfp_st_base_calculo
					alias_attribute :vBCFCPST, :cfp_st_base_calculo
					...
					# <b>tag:      </b> pFCPST
					#
					attr_accessor :cfp_st_percentual
					alias_attribute :pFCPST, :cfp_st_percentual
					...
					# <b>tag:      </b> vFCPST
					#
					attr_accessor :cfp_st_valor
					alias_attribute :vFCPST, :cfp_st_valor
					...
					# <b>tag:      </b> pST
					#
					attr_accessor :aliquota_consumidor_final
					alias_attribute :pST, :aliquota_consumidor_final
					...
					# <b>tag:      </b> vBCFCPSTRet
					#
					attr_accessor :cfp_st_retido_base_calculo
					alias_attribute :vBCFCPSTRet, :cfp_st_retido_base_calculo
					...
					# <b>tag:      </b> pFCPSTRet
					#
					attr_accessor :cfp_st_retido_percentual
					alias_attribute :pFCPSTRet, :cfp_st_retido_percentual
					...
					# <b>tag:      </b> vFCPSTRet
					#
					attr_accessor :cfp_st_retido_valor
					alias_attribute :vFCPSTRet, :cfp_st_retido_valor
