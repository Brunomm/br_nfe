...
describe BrNfe::Service::Ciga::V1::CancelaNfse do
	subject             { FactoryGirl.build(:service_ciga_v1_cancela_nfse, emitente: emitente) }
	...
	# 		fixture = read_fixture('service/response/ciga/v1/cancela_nfse/success.xml')
	...
	# 		fixture = read_fixture('service/response/ciga/v1/cancela_nfse/fault.xml')
