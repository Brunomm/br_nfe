...
describe BrNfe::Service::Webiss::V1::CancelaNfse do
	subject             { FactoryGirl.build(:service_webiss_v1_cancela_nfse, emitente: emitente) }
	...
	# 		fixture = read_fixture('service/response/webiss/v1/cancela_nfse/success.xml')
	...
	# 		fixture = read_fixture('service/response/webiss/v1/cancela_nfse/fault.xml')
