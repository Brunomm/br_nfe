...
describe BrNfe::Service::Ciga::V1::RecepcaoLoteRps do
	subject        { FactoryGirl.build(:service_ciga_v1_recepcao_lote_rps, emitente: emitente) }
	...
	# 		fixture = read_fixture('service/response/ciga/v1/recepcao_lote_rps/success.xml')
	...
	# 		fixture = read_fixture('service/response/ciga/v1/recepcao_lote_rps/error.xml')
