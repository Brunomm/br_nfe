...
describe BrNfe::Service::PE::Recife::V1::CancelaNfse do
	subject             { FactoryGirl.build(:service_pe_recife_v1_cancela_nfse, emitente: emitente) }
	...
	# 		fixture = read_fixture('service/response/pe/recife/v1/cancela_nfse/success.xml')
	...
	# 		fixture = read_fixture('service/response/pe/recife/v1/cancela_nfse/fault.xml')
