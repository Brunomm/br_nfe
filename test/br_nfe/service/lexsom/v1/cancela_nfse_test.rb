...
describe BrNfe::Service::Lexsom::V1::CancelaNfse do
	subject             { FactoryGirl.build(:service_lexsom_v1_cancela_nfse, emitente: emitente) }
	...
	# 		fixture = read_fixture('service/response/lexsom/v1/cancela_nfse/success.xml')
	...
	# 		fixture = read_fixture('service/response/lexsom/v1/cancela_nfse/fault.xml')
