...
describe BrNfe::Service::Ginfes::V1::RecepcaoLoteRps do
	subject        { FactoryGirl.build(:service_ginfes_v1_recepcao_lote_rps, emitente: emitente) }
	...
	describe "#method_wsdl" do
		it { subject.method_wsdl.must_equal :recepcionar_lote_rps_v3 }
	end

	it "#soap_body_root_tag" do
		subject.soap_body_root_tag.must_equal 'RecepcionarLoteRpsV3'
	end
	...
	describe "Validação do XML através do XSD" do
		...
		def validate_schema
			Dir.chdir(schemas_dir) do
				schema = Nokogiri::XML::Schema(IO.read('servico_enviar_lote_rps_envio_v03.xsd'))
	...
	# 		fixture = read_fixture('service/response/ginfes/v1/recepcao_lote_rps/success.xml')
	...
	# 		fixture = read_fixture('service/response/ginfes/v1/recepcao_lote_rps/error.xml')
