...
describe BrNfe::Service::Speedgov::V1::ConsultaNfse do
	subject             { FactoryGirl.build(:service_speedgov_v1_consulta_nfse, emitente: emitente) }
		...
		describe "Validações a partir do arquivo XSD" do
			it "Deve ser válido com 1 RPS com todas as informações preenchidas" do
				Dir.chdir(schemas_dir) do
					schema = Nokogiri::XML::Schema(IO.read('consultar_nfse_envio_v1.xsd'))
	...
	# 		fixture = read_fixture('service/response/speedgov/v1/consulta_nfse/nfs_empty.xml')
	...
	# 		fixture = read_fixture('service/response/speedgov/v1/consulta_nfse/fault.xml')
	...
	# 		fixture = read_fixture('service/response/speedgov/v1/consulta_nfse/nfse_simple.xml')
	# 		savon.expects(:consultar_nfse).returns(fixture)
	# 		subject.request
	# 		response = subject.response
	...
	# 		fixture = read_fixture('service/response/speedgov/v1/consulta_nfse/nfse_complete.xml')
	# 		savon.expects(:consultar_nfse).returns(fixture)
	# 		subject.request
	# 		response = subject.response
