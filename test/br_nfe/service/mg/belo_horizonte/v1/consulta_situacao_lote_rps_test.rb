...
describe BrNfe::Service::MG::BeloHorizonte::V1::ConsultaSituacaoLoteRps do
	subject        { FactoryGirl.build(:br_nfe_service_mg_bh_v1_consulta_situacao_lote_rps, emitente: emitente) }
	let(:emitente) { FactoryGirl.build(:service_emitente)   }
	
	describe "superclass" do
		it { subject.class.superclass.must_equal BrNfe::Service::MG::BeloHorizonte::V1::ConsultaLoteRps }
	end
