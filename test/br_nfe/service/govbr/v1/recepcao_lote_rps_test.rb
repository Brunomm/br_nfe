...
describe BrNfe::Service::Govbr::V1::RecepcaoLoteRps do
	subject        { FactoryGirl.build(:service_govbr_v1_recepcao_lote_rps, emitente: emitente) }
	...
	# 		fixture = read_fixture('service/response/govbr/v1/recepcao_lote_rps/success.xml')
	...
	# 		fixture = read_fixture('service/response/govbr/v1/recepcao_lote_rps/error.xml')
