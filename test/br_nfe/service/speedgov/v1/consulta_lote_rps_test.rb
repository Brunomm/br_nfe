...
describe BrNfe::Service::Speedgov::V1::ConsultaLoteRps do
	subject             { FactoryGirl.build(:service_speedgov_v1_consulta_lote_rps, emitente: emitente) }
		...
		describe "Validações a partir do arquivo XSD" do
			it "Deve ser válido com 1 RPS com todas as informações preenchidas" do
				...
				Dir.chdir(schemas_dir) do
					schema = Nokogiri::XML::Schema(IO.read('consultar_lote_rps_envio_v1.xsd'))
	...
	# 		fixture = read_fixture('service/response/speedgov/v1/consulta_lote_rps/fault.xml')
	...
	# 		fixture = read_fixture('service/response/speedgov/v1/consulta_lote_rps/nfse_simple.xml')
	# 		savon.expects(:consultar_lote_rps).returns(fixture)
	# 		subject.request
	# 		response = subject.response
	...
	# 		fixture = read_fixture('service/response/speedgov/v1/consulta_lote_rps/nfse_complete.xml')
	# 		savon.expects(:consultar_lote_rps).returns(fixture)
	# 		subject.request
	# 		response = subject.response
