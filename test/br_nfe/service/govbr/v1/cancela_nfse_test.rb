...
describe BrNfe::Service::Govbr::V1::CancelaNfse do
	subject             { FactoryGirl.build(:service_govbr_v1_cancela_nfse, emitente: emitente) }
	...
	# 		fixture = read_fixture('service/response/govbr/v1/cancela_nfse/success.xml')
	...
	# 		fixture = read_fixture('service/response/govbr/v1/cancela_nfse/fault.xml')
