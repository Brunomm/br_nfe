...
describe BrNfe::Service::PR::Curitiba::V1::ConsultaLoteRps do
	subject             { FactoryGirl.build(:service_pr_curitiba_v1_consulta_lote_rps, emitente: emitente) }
	...
	# 		fixture = read_fixture('service/response/pr/curitiba/v1/consulta_lote_rps/success.xml')
	...
	# 		fixture = read_fixture('service/response/pr/curitiba/v1/consulta_lote_rps/error.xml')
	# 		savon.expects(:consultar_lote_rps).returns(fixture)
	# 		subject.request
	# 		response = subject.response
	...
	# 		fixture = read_fixture('service/response/pr/curitiba/v1/consulta_lote_rps/unprocessed.xml')
	# 		savon.expects(:consultar_lote_rps).returns(fixture)
	# 		subject.request
	# 		response = subject.response
	...
	# 		fixture = read_fixture('service/response/pr/curitiba/v1/consulta_lote_rps/unreceived.xml')
	# 		savon.expects(:consultar_lote_rps).returns(fixture)
	# 		subject.request
	# 		response = subject.response
	...
	# 		fixture = read_fixture('service/response/pr/curitiba/v1/consulta_lote_rps/fault.xml')
