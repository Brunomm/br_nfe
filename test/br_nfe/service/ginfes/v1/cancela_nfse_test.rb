...
describe BrNfe::Service::Ginfes::V1::CancelaNfse do
	subject             { FactoryGirl.build(:service_ginfes_v1_cancela_nfse, emitente: emitente) }
	...
	describe "#method_wsdl" do
		it { subject.method_wsdl.must_equal :cancelar_nfse_v3 }
	end
	...
	it "#soap_body_root_tag" do
		subject.soap_body_root_tag.must_equal 'CancelarNfseV3'
	end
		...
		describe "Validações a partir do arquivo XSD" do
			it "Deve ser válido com 1 RPS com todas as informações preenchidas" do				
				Dir.chdir(schemas_dir) do
					schema = Nokogiri::XML::Schema(IO.read('servico_cancelar_nfse_envio_v03.xsd'))
	...
	# 		fixture = read_fixture('service/response/ginfes/v1/cancela_nfse/success.xml')
	...
	# 		fixture = read_fixture('service/response/ginfes/v1/cancela_nfse/fault.xml')
