...
describe BrNfe::Service::PE::Recife::V1::ConsultaLoteRps do
	subject             { FactoryGirl.build(:service_pe_recife_v1_consulta_lote_rps, emitente: emitente) }
	...
	it "#soap_body_root_tag" do
		subject.soap_body_root_tag.must_equal 'ConsultarLoteRpsRequest'
	end
	...
	# 		fixture = read_fixture('service/response/pe/recife/v1/consulta_lote_rps/success.xml')
	...
	# 		fixture = read_fixture('service/response/pe/recife/v1/consulta_lote_rps/error.xml')
	# 		savon.expects(:consultar_lote_rps).returns(fixture)
	# 		subject.request
	# 		response = subject.response
	...
	# 		fixture = read_fixture('service/response/pe/recife/v1/consulta_lote_rps/unprocessed.xml')
	# 		savon.expects(:consultar_lote_rps).returns(fixture)
	# 		subject.request
	# 		response = subject.response
	...
	# 		fixture = read_fixture('service/response/pe/recife/v1/consulta_lote_rps/unreceived.xml')
	# 		savon.expects(:consultar_lote_rps).returns(fixture)
	# 		subject.request
	# 		response = subject.response
	...
	# 		fixture = read_fixture('service/response/pe/recife/v1/consulta_lote_rps/fault.xml')
