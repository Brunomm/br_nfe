...
describe BrNfe::Service::Ciga::V1::ConsultaNfse do
	subject             { FactoryGirl.build(:service_ciga_v1_consulta_nfse, emitente: emitente) }
	...
	# 		fixture = read_fixture('service/response/ciga/v1/consulta_nfse/nfs_empty.xml')
	...
	# 		fixture = read_fixture('service/response/ciga/v1/consulta_nfse/fault.xml')
	...
	# 		fixture = read_fixture('service/response/ciga/v1/consulta_nfse/nfse_simple.xml')
	# 		savon.expects(:consultar_nfse).returns(fixture)
	# 		subject.request
	# 		response = subject.response
	...
	# 		fixture = read_fixture('service/response/ciga/v1/consulta_nfse/nfse_complete.xml')
	# 		savon.expects(:consultar_nfse).returns(fixture)
	# 		subject.request
	# 		response = subject.response
