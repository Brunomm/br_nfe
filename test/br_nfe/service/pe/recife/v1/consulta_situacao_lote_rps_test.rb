...
describe BrNfe::Service::PE::Recife::V1::ConsultaSituacaoLoteRps do
	subject             { FactoryGirl.build(:service_pe_recife_v1_consulta_situacao_lote_rps, emitente: emitente) }
	...
	# 		fixture = read_fixture('service/response/pe/recife/v1/consulta_situacao_lote_rps/success.xml')
	...
	# 		fixture = read_fixture('service/response/pe/recife/v1/consulta_situacao_lote_rps/error.xml')
	# 		savon.expects(:consultar_situacao_lote_rps).returns(fixture)
	# 		subject.request
	# 		response = subject.response
	...
	# 		fixture = read_fixture('service/response/pe/recife/v1/consulta_situacao_lote_rps/unprocessed.xml')
	# 		savon.expects(:consultar_situacao_lote_rps).returns(fixture)
	# 		subject.request
	# 		response = subject.response
	...
	# 		fixture = read_fixture('service/response/pe/recife/v1/consulta_situacao_lote_rps/unreceived.xml')
	# 		savon.expects(:consultar_situacao_lote_rps).returns(fixture)
	# 		subject.request
	# 		response = subject.response
	...
	# 		fixture = read_fixture('service/response/pe/recife/v1/consulta_situacao_lote_rps/fault.xml')
