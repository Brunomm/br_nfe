...
describe BrNfe::Service::MG::BeloHorizonte::V1::ConsultaNfsPorRps do
	subject        { FactoryGirl.build(:br_nfe_service_mg_bh_v1_consulta_nfs_por_rps, emitente: emitente) }
	...
	describe "#request and set response" do
		...
		it "Quando encontrar uma nota fiscal" do
			...
			nf.xml_nf[0..89].must_equal '<ConsultarNfseRpsResposta xmlns="http://www.abrasf.org.br/ABRASF/arquivos/nfse.xsd"><Lista'
