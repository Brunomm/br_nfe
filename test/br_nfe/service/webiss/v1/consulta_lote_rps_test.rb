...
describe BrNfe::Service::Webiss::V1::ConsultaLoteRps do
	subject             { FactoryGirl.build(:service_webiss_v1_consulta_lote_rps, emitente: emitente) }
	let(:emitente)      { FactoryGirl.build(:service_emitente) }

	it { must validate_presence_of(:protocolo) }

	describe "superclass" do
		it { subject.class.superclass.must_equal BrNfe::Service::Webiss::V1::Base }
	end
	...
	describe "Validação do XML através do XSD" do
		let(:schemas_dir) { BrNfe.root+'/test/fixtures/service/schemas/webiss/V1' }
		describe "Validações a partir do arquivo XSD" do
			it "Deve ser válidado pelo schema" do
				Dir.chdir(schemas_dir) do
					schema = Nokogiri::XML::Schema(IO.read('servico_consultar_lote_rps_envio.xsd'))
	...
	# 		fixture = read_fixture('service/response/webiss/v1/consulta_lote_rps/success.xml')
	...
	# 		fixture = read_fixture('service/response/webiss/v1/consulta_lote_rps/error.xml')
	# 		savon.expects(:consultar_lote_rps).returns(fixture)
	# 		subject.request
	# 		response = subject.response
	...
	# 		fixture = read_fixture('service/response/webiss/v1/consulta_lote_rps/unprocessed.xml')
	# 		savon.expects(:consultar_lote_rps).returns(fixture)
	# 		subject.request
	# 		response = subject.response
	...
	# 		fixture = read_fixture('service/response/webiss/v1/consulta_lote_rps/unreceived.xml')
	# 		savon.expects(:consultar_lote_rps).returns(fixture)
	# 		subject.request
	# 		response = subject.response
	...
	# 		fixture = read_fixture('service/response/webiss/v1/consulta_lote_rps/fault.xml')
