...
describe BrNfe::Service::Lexsom::V1::RecepcaoLoteRps do
	subject        { FactoryGirl.build(:service_lexsom_v1_recepcao_lote_rps, emitente: emitente) }
	...
	describe "#method_wsdl" do
		it { subject.method_wsdl.must_equal :recebe_lote_rps }
	end

	it "#soap_body_root_tag" do
		subject.soap_body_root_tag.must_equal 'RecebeLoteRPS'
	end
	...
	# 		fixture = read_fixture('service/response/lexsom/v1/recepcao_lote_rps/success.xml')
	...
	# 		fixture = read_fixture('service/response/lexsom/v1/recepcao_lote_rps/error.xml')
