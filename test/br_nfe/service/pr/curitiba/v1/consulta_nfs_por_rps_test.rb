...
describe BrNfe::Service::PR::Curitiba::V1::ConsultaNfsPorRps do
	subject             { FactoryGirl.build(:service_pr_curitiba_v1_consulta_nfs_por_rps, emitente: emitente) }
	...
	describe "#request and set response" do
		...
		# 	fixture = read_fixture('service/response/pr/curitiba/v1/consulta_nfse_por_rps/fault.xml')
	...
	# 		fixture = read_fixture('service/response/pr/curitiba/v1/consulta_nfse_por_rps/nfse_simple.xml')
	# 		savon.expects(:consultar_nfse_por_rps).returns(fixture)
	# 		subject.request
	# 		response = subject.response
	...
	# 		fixture = read_fixture('service/response/pr/curitiba/v1/consulta_nfse_por_rps/nfse_complete.xml')
	# 		savon.expects(:consultar_nfse_por_rps).returns(fixture)
	# 		subject.request
	# 		response = subject.response
