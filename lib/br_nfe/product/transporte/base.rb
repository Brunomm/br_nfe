	...
	module Product
		module Transporte
			class Base < BrNfe::ActiveModelBase
				...
				#
				# Exemplo com Objetos:
				#    self.reboques = [BrNfe::Product::Transporte::Veiculo.new({placa: 'XXX6644', uf: 'PI', ...}),{placa: 'XXX6644', uf: 'RS', ...}]
				#    self.reboques << BrNfe::Product::Transporte::Veiculo.new({placa: 'XXX6644', uf: 'PR', ...})
				...
				#
				# <b>Tipo: </b> _BrNfe.veiculo_product_class (BrNfe::Product::Transporte::Veiculo)_
				# <b>Min: </b> _0_
				# <b>Max: </b> _5_
				# <b>Default: </b> _[]_
				#
				...
				#
				# Exemplo com Objetos:
				#    self.volumes = [BrNfe::Product::Transporte::Volume.new({marca: 'XXX6644', quantidade: 12, ...}),{marca: 'XXX6644', quantidade: 13, ...}]
				#    self.volumes << BrNfe::Product::Transporte::Volume.new({marca: 'XXX6644', quantidade: 14, ...})
				...
				#
				# <b>Tipo: </b> _BrNfe.volume_transporte_product_class (BrNfe::Product::Transporte::Volume)_
				# <b>Min: </b> _0_
				# <b>Max: </b> _5_
				# <b>Default: </b> _[]_
				#
