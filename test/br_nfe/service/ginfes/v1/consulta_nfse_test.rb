...
describe BrNfe::Service::Ginfes::V1::ConsultaNfse do
	subject             { FactoryGirl.build(:service_ginfes_v1_consulta_nfse, emitente: emitente) }
	...
	describe "#method_wsdl" do
		it { subject.method_wsdl.must_equal :consultar_nfse_v3 }
	end

	it "#soap_body_root_tag" do
		subject.soap_body_root_tag.must_equal 'ConsultarNfseV3'
	end
		...
		describe "Validações a partir do arquivo XSD" do
			it "Deve ser válido com 1 RPS com todas as informações preenchidas" do
				Dir.chdir(schemas_dir) do
					schema = Nokogiri::XML::Schema(IO.read('servico_consultar_nfse_envio_v03.xsd'))
	...
	# 		fixture = read_fixture('service/response/ginfes/v1/consulta_nfse/nfs_empty.xml')
	...
	# 		fixture = read_fixture('service/response/ginfes/v1/consulta_nfse/fault.xml')
	...
	# 		fixture = read_fixture('service/response/ginfes/v1/consulta_nfse/nfse_simple.xml')
	# 		savon.expects(:consultar_nfse).returns(fixture)
	# 		subject.request
	# 		response = subject.response
	...
	# 		fixture = read_fixture('service/response/ginfes/v1/consulta_nfse/nfse_complete.xml')
	# 		savon.expects(:consultar_nfse).returns(fixture)
	# 		subject.request
	# 		response = subject.response
