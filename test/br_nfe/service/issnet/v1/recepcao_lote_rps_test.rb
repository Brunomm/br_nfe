...
describe BrNfe::Service::Issnet::V1::RecepcaoLoteRps do
	subject        { FactoryGirl.build(:service_issnet_v1_recepcao_lote_rps, emitente: emitente) }
	...
	describe "Validação do XML através do XSD" do
		...
		def validate_schema
			Dir.chdir(schemas_dir) do
				schema = Nokogiri::XML::Schema(IO.read('servico_enviar_lote_rps_envio.xsd'))
	...
	# 		fixture = read_fixture('service/response/issnet/v1/recepcao_lote_rps/success.xml')
	...
	# 		fixture = read_fixture('service/response/issnet/v1/recepcao_lote_rps/error.xml')
