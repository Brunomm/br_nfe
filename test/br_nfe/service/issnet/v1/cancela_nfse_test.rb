...
describe BrNfe::Service::Issnet::V1::CancelaNfse do
	subject             { FactoryGirl.build(:service_issnet_v1_cancela_nfse, emitente: emitente) }
		...
		describe "Validações a partir do arquivo XSD" do
			it "Deve ser válido com 1 RPS com todas as informações preenchidas" do
				...
				Dir.chdir(schemas_dir) do
					schema = Nokogiri::XML::Schema(IO.read('servico_cancelar_nfse_envio.xsd'))
	...
	# 		fixture = read_fixture('service/response/issnet/v1/cancela_nfse/success.xml')
	...
	# 		fixture = read_fixture('service/response/issnet/v1/cancela_nfse/fault.xml')
