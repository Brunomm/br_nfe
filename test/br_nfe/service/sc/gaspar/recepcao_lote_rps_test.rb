...
describe BrNfe::Service::SC::Gaspar::RecepcaoLoteRps do
	subject { FactoryGirl.build(:service_sc_gaspar_recepcao_lote_rps, emitente: emitente) }
	let(:emitente) { FactoryGirl.build(:emitente, natureza_operacao: 51) } 
	
	it "A classe deve herdar de BrNfe::Service::Thema::V1::RecepcaoLoteRps" do
		subject.must_be_kind_of BrNfe::Service::Thema::V1::RecepcaoLoteRps
	end
