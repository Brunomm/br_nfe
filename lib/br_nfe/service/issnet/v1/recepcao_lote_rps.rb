module BrNfe
	module Service
		module Issnet
			module V1
				class RecepcaoLoteRps < BrNfe::Service::Issnet::V1::Base
					...
					def message_namespaces
						super.merge({'xmlns:ns2' =>  "http://www.issnetonline.com.br/webserviceabrasf/vsd/servico_enviar_lote_rps_envio.xsd",})
					end
