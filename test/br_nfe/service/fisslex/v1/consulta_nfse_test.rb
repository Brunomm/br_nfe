...
describe BrNfe::Service::Fisslex::V1::ConsultaNfse do
	subject             { FactoryGirl.build(:service_fisslex_v1_consulta_nfse, emitente: emitente) }
	...
	describe "#wsdl" do
		it "default" do
			...
			subject.wsdl.must_equal 'https://demo.fisslex.com.br/fiss-lex/servlet/aws_consultanfse?wsdl'
			subject.env = :test
			subject.wsdl.must_equal 'https://demo.fisslex.com.br/fiss-lex/servlet/aws_consultanfse?wsdl'
		end
		...
		describe 'Para a cidade 5101704 - Barra do Bugres - MT' do
			...
			it "ambiente de produção" do
				subject.env = :production
				subject.wsdl.must_equal 'https://barradobugres.fisslex.com.br/fiss-lex/servlet/aws_consultanfse?wsdl'
			end
		...
		describe 'Para a cidade 5105101 - Juara - MT' do
			...
			it "ambiente de produção" do
				subject.env = :production
				subject.wsdl.must_equal 'https://juara.fisslex.com.br/fiss-lex/servlet/aws_consultanfse?wsdl'
			end
			it "ambiente de testes" do
				subject.env = :test
				subject.wsdl.must_equal 'https://demo.fisslex.com.br/fiss-lex/servlet/aws_consultanfse?wsdl'
		...
		describe 'Para a cidade 5105150 - Juina - MT' do
			...
			it "ambiente de produção" do
				subject.env = :production
				subject.wsdl.must_equal 'https://juina.fisslex.com.br/fiss-lex/servlet/aws_consultanfse?wsdl'
			end
			it "ambiente de testes" do
				subject.env = :test
				subject.wsdl.must_equal 'https://demo.fisslex.com.br/fiss-lex/servlet/aws_consultanfse?wsdl'
		...
		describe 'Para a cidade 5106232 - Nova Olimpia - MT' do
			...
			it "ambiente de produção" do
				subject.env = :production
				subject.wsdl.must_equal 'https://novaolimpia.fisslex.com.br/fiss-lex/servlet/aws_consultanfse?wsdl'
			end
			it "ambiente de testes" do
				subject.env = :test
				subject.wsdl.must_equal 'https://demo.fisslex.com.br/fiss-lex/servlet/aws_consultanfse?wsdl'
		...
		describe 'Para a cidade 5107248 - Santa Carmem - MT' do
			...
			it "ambiente de produção" do
				subject.env = :production
				subject.wsdl.must_equal 'https://santacarmem.fisslex.com.br/fiss-lex/servlet/aws_consultanfse?wsdl'
			end
			it "ambiente de testes" do
				subject.env = :test
				subject.wsdl.must_equal 'https://demo.fisslex.com.br/fiss-lex/servlet/aws_consultanfse?wsdl'
		...
		describe 'Para a cidade 5107800 - Santo António do Leverger - MT' do
			...
			it "ambiente de produção" do
				subject.env = :production
				subject.wsdl.must_equal 'https://leverger.fisslex.com.br/fiss-lex/servlet/aws_consultanfse?wsdl'
			end
			it "ambiente de testes" do
				subject.env = :test
				subject.wsdl.must_equal 'https://demo.fisslex.com.br/fiss-lex/servlet/aws_consultanfse?wsdl'
		...
		describe 'Para a cidade 5107875 - Sapezal - MT' do
			...
			it "ambiente de produção" do
				subject.env = :production
				subject.wsdl.must_equal 'https://sapezal.fisslex.com.br/fiss-lex/servlet/aws_consultanfse?wsdl'
			end
			it "ambiente de testes" do
				subject.env = :test
				subject.wsdl.must_equal 'https://demo.fisslex.com.br/fiss-lex/servlet/aws_consultanfse?wsdl'
		...
		describe 'Para a cidade 5107909 - Sinop - MT' do
			...
			it "ambiente de produção" do
				subject.env = :production
				subject.wsdl.must_equal 'https://sinop.fisslex.com.br/fiss-lex/servlet/aws_consultanfse?wsdl'
			end
			it "ambiente de testes" do
				subject.env = :test
				subject.wsdl.must_equal 'https://demo.fisslex.com.br/fiss-lex/servlet/aws_consultanfse?wsdl'
		...
		describe 'Para a cidade 1100106 - Guajará-Mirim - RO' do
			...
			it "ambiente de produção" do
				subject.env = :production
				subject.wsdl.must_equal 'https://guajara.fisslex.com.br/fiss-lex/servlet/aws_consultanfse?wsdl'
			end
			it "ambiente de testes" do
				subject.env = :test
				subject.wsdl.must_equal 'https://demo.fisslex.com.br/fiss-lex/servlet/aws_consultanfse?wsdl'
	...
	describe "#method_wsdl" do
		...
		# it { subject.method_wsdl.must_equal :consulta_nfse }
	end

	it "#soap_body_root_tag" do
		subject.soap_body_root_tag.must_equal 'WS_ConsultaNfse.Execute'
		# subject.soap_body_root_tag.must_equal 'ConsultaNFSE'
	end
	...
	# 		fixture = read_fixture('service/response/fisslex/v1/consulta_nfse/nfs_empty.xml')
	...
	# 		fixture = read_fixture('service/response/fisslex/v1/consulta_nfse/fault.xml')
	...
	# 		fixture = read_fixture('service/response/fisslex/v1/consulta_nfse/nfse_simple.xml')
	# 		savon.expects(:consultar_nfse).returns(fixture)
	# 		subject.request
	# 		response = subject.response
	...
	# 		fixture = read_fixture('service/response/fisslex/v1/consulta_nfse/nfse_complete.xml')
	# 		savon.expects(:consultar_nfse).returns(fixture)
	# 		subject.request
	# 		response = subject.response
