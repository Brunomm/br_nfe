...
describe BrNfe::Service::Issnet::V1::ConsultaLoteRps do
	subject             { FactoryGirl.build(:service_issnet_v1_consulta_lote_rps, emitente: emitente) }
	...
	# 		fixture = read_fixture('service/response/issnet/v1/consulta_lote_rps/fault.xml')
	...
	# 		fixture = read_fixture('service/response/issnet/v1/consulta_lote_rps/nfse_simple.xml')
	# 		savon.expects(:consultar_lote_rps).returns(fixture)
	# 		subject.request
	# 		response = subject.response
	...
	# 		fixture = read_fixture('service/response/issnet/v1/consulta_lote_rps/nfse_complete.xml')
	# 		savon.expects(:consultar_lote_rps).returns(fixture)
	# 		subject.request
	# 		response = subject.response
