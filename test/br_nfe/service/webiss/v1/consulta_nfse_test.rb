...
describe BrNfe::Service::Webiss::V1::ConsultaNfse do
	subject             { FactoryGirl.build(:service_webiss_v1_consulta_nfse, emitente: emitente) }
	...
	describe "#request and set response" do
		...
		it "Se não encontrar nenhuma NFe" do
			fixture = read_fixture('service/response/webiss/v1/consulta_nfse/nfs_empty.xml')
		...
		# 	fixture = read_fixture('service/response/webiss/v1/consulta_nfse/fault.xml')
		...
		# 	fixture = read_fixture('service/response/webiss/v1/consulta_nfse/nfse_simple.xml')
		# 	savon.expects(:consultar_nfse).returns(fixture)
		# 	subject.request
		# 	response = subject.response
		...
		# 	fixture = read_fixture('service/response/webiss/v1/consulta_nfse/nfse_complete.xml')
		# 	savon.expects(:consultar_nfse).returns(fixture)
		# 	subject.request
		# 	response = subject.response
