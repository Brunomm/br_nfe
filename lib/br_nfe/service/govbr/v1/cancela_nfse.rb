module BrNfe
	module Service
		module Govbr
			module V1
				class CancelaNfse < BrNfe::Service::Govbr::V1::Base
					...
					def message_namespaces
						# super.merge({'xmlns:ns3' =>  "http://tempuri.org/servico_cancelar_nfse_envio.xsd",})
						super.merge({'xmlns:ns3' =>  "http://tempuri.org/servico_enviar_lote_rps_envio.xsd",})
					end
