...
describe BrNfe::Service::Dbseller::V1::CancelaNfse do
	subject             { FactoryGirl.build(:service_dbseller_v1_cancela_nfse, emitente: emitente) }
	...
	# 		fixture = read_fixture('service/response/dbseller/v1/cancela_nfse/success.xml')
	...
	# 		fixture = read_fixture('service/response/dbseller/v1/cancela_nfse/fault.xml')
