...
describe BrNfe::Service::Issnet::V1::ConsultaNfsPorRps do
	subject             { FactoryGirl.build(:service_issnet_v1_consulta_nfs_por_rps, emitente: emitente) }
	let(:emitente)      { FactoryGirl.build(:service_emitente) }
	let(:rps)           { subject.rps } 

	describe "superclass" do
		it { subject.class.superclass.must_equal BrNfe::Service::Issnet::V1::Base }
	end
	...
	describe "#method_wsdl" do
		it { subject.method_wsdl.must_equal :consulta_nf_se_por_rps }
		...
		describe "Validações a partir do arquivo XSD" do
			...
			it "Deve ser válido com 1 RPS com todas as informações preenchidas" do
				...
				Dir.chdir(schemas_dir) do
					schema = Nokogiri::XML::Schema(IO.read('servico_consultar_nfse_rps_envio.xsd'))
	...
	# 		fixture = read_fixture('service/response/issnet/v1/consulta_nfse_por_rps/fault.xml')
	...
	# 		fixture = read_fixture('service/response/issnet/v1/consulta_nfse_por_rps/nfse_simple.xml')
	# 		savon.expects(:consultar_nfse_por_rps).returns(fixture)
	# 		subject.request
	# 		response = subject.response
	...
	# 		fixture = read_fixture('service/response/issnet/v1/consulta_nfse_por_rps/nfse_complete.xml')
	# 		savon.expects(:consultar_nfse_por_rps).returns(fixture)
	# 		subject.request
	# 		response = subject.response
