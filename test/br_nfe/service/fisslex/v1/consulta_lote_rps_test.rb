...
describe BrNfe::Service::Fisslex::V1::ConsultaLoteRps do
	subject             { FactoryGirl.build(:service_fisslex_v1_consulta_lote_rps, emitente: emitente) }
	...
	describe "#wsdl" do
		it "default" do
			...
			subject.wsdl.must_equal 'https://demo.fisslex.com.br/fiss-lex/servlet/aws_consultaloterps?wsdl'
			subject.env = :test
			subject.wsdl.must_equal 'https://demo.fisslex.com.br/fiss-lex/servlet/aws_consultaloterps?wsdl'
		end
		...
		describe 'Para a cidade 5101704 - Barra do Bugres - MT' do
			...
			it "ambiente de produção" do
				subject.env = :production
				subject.wsdl.must_equal 'https://barradobugres.fisslex.com.br/fiss-lex/servlet/aws_consultaloterps?wsdl'
			end
		...
		describe 'Para a cidade 5105101 - Juara - MT' do
			...
			it "ambiente de produção" do
				subject.env = :production
				subject.wsdl.must_equal 'https://juara.fisslex.com.br/fiss-lex/servlet/aws_consultaloterps?wsdl'
			end
			it "ambiente de testes" do
				subject.env = :test
				subject.wsdl.must_equal 'https://demo.fisslex.com.br/fiss-lex/servlet/aws_consultaloterps?wsdl'
		...
		describe 'Para a cidade 5105150 - Juina - MT' do
			...
			it "ambiente de produção" do
				subject.env = :production
				subject.wsdl.must_equal 'https://juina.fisslex.com.br/fiss-lex/servlet/aws_consultaloterps?wsdl'
			end
			it "ambiente de testes" do
				subject.env = :test
				subject.wsdl.must_equal 'https://demo.fisslex.com.br/fiss-lex/servlet/aws_consultaloterps?wsdl'
		...
		describe 'Para a cidade 5106232 - Nova Olimpia - MT' do
			...
			it "ambiente de produção" do
				subject.env = :production
				subject.wsdl.must_equal 'https://novaolimpia.fisslex.com.br/fiss-lex/servlet/aws_consultaloterps?wsdl'
			end
			it "ambiente de testes" do
				subject.env = :test
				subject.wsdl.must_equal 'https://demo.fisslex.com.br/fiss-lex/servlet/aws_consultaloterps?wsdl'
		...
		describe 'Para a cidade 5107248 - Santa Carmem - MT' do
			...
			it "ambiente de produção" do
				subject.env = :production
				subject.wsdl.must_equal 'https://santacarmem.fisslex.com.br/fiss-lex/servlet/aws_consultaloterps?wsdl'
			end
			it "ambiente de testes" do
				subject.env = :test
				subject.wsdl.must_equal 'https://demo.fisslex.com.br/fiss-lex/servlet/aws_consultaloterps?wsdl'
		...
		describe 'Para a cidade 5107800 - Santo António do Leverger - MT' do
			...
			it "ambiente de produção" do
				subject.env = :production
				subject.wsdl.must_equal 'https://leverger.fisslex.com.br/fiss-lex/servlet/aws_consultaloterps?wsdl'
			end
			it "ambiente de testes" do
				subject.env = :test
				subject.wsdl.must_equal 'https://demo.fisslex.com.br/fiss-lex/servlet/aws_consultaloterps?wsdl'
		...
		describe 'Para a cidade 5107875 - Sapezal - MT' do
			...
			it "ambiente de produção" do
				subject.env = :production
				subject.wsdl.must_equal 'https://sapezal.fisslex.com.br/fiss-lex/servlet/aws_consultaloterps?wsdl'
			end
			it "ambiente de testes" do
				subject.env = :test
				subject.wsdl.must_equal 'https://demo.fisslex.com.br/fiss-lex/servlet/aws_consultaloterps?wsdl'
		...
		describe 'Para a cidade 5107909 - Sinop - MT' do
			...
			it "ambiente de produção" do
				subject.env = :production
				subject.wsdl.must_equal 'https://sinop.fisslex.com.br/fiss-lex/servlet/aws_consultaloterps?wsdl'
			end
			it "ambiente de testes" do
				subject.env = :test
				subject.wsdl.must_equal 'https://demo.fisslex.com.br/fiss-lex/servlet/aws_consultaloterps?wsdl'
		...
		describe 'Para a cidade 1100106 - Guajará-Mirim - RO' do
			...
			it "ambiente de produção" do
				subject.env = :production
				subject.wsdl.must_equal 'https://guajara.fisslex.com.br/fiss-lex/servlet/aws_consultaloterps?wsdl'
			end
			it "ambiente de testes" do
				subject.env = :test
				subject.wsdl.must_equal 'https://demo.fisslex.com.br/fiss-lex/servlet/aws_consultaloterps?wsdl'
	...
	# 		fixture = read_fixture('service/response/fisslex/v1/consulta_lote_rps/success.xml')
	...
	# 		fixture = read_fixture('service/response/fisslex/v1/consulta_lote_rps/error.xml')
	# 		savon.expects(:consultar_lote_rps).returns(fixture)
	# 		subject.request
	# 		response = subject.response
	...
	# 		fixture = read_fixture('service/response/fisslex/v1/consulta_lote_rps/unprocessed.xml')
	# 		savon.expects(:consultar_lote_rps).returns(fixture)
	# 		subject.request
	# 		response = subject.response
	...
	# 		fixture = read_fixture('service/response/fisslex/v1/consulta_lote_rps/unreceived.xml')
	# 		savon.expects(:consultar_lote_rps).returns(fixture)
	# 		subject.request
	# 		response = subject.response
	...
	# 		fixture = read_fixture('service/response/fisslex/v1/consulta_lote_rps/fault.xml')
