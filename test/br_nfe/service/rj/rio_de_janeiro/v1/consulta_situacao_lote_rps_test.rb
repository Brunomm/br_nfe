...
describe BrNfe::Service::RJ::RioDeJaneiro::V1::ConsultaSituacaoLoteRps do
	subject             { FactoryGirl.build(:service_rj_rj_v1_consulta_situacao_lote_rps, emitente: emitente) }
	...
	describe "#request and set response" do
		...
		it "Quando processou o RPS com sucesso deve setar a situation com :success" do
			fixture = read_fixture('service/response/rj/rio_de_janeiro/v1/consulta_situacao_lote_rps/success.xml')
		...
		it "Quando processou o RPS com erros deve setar a situation com :error" do
			fixture = read_fixture('service/response/rj/rio_de_janeiro/v1/consulta_situacao_lote_rps/error.xml')
			savon.expects(:consultar_situacao_lote_rps).returns(fixture)
			subject.request
			response = subject.response
		...
		it "Quando não processou o RPS deve setar a situation com :unprocessed" do
			fixture = read_fixture('service/response/rj/rio_de_janeiro/v1/consulta_situacao_lote_rps/unprocessed.xml')
			savon.expects(:consultar_situacao_lote_rps).returns(fixture)
			subject.request
			response = subject.response
		...
		it "Quando não encontrar o RPS deve setar a situation com :unreceived" do
			fixture = read_fixture('service/response/rj/rio_de_janeiro/v1/consulta_situacao_lote_rps/unreceived.xml')
			savon.expects(:consultar_situacao_lote_rps).returns(fixture)
			subject.request
			response = subject.response
		...
		it "Quando a requisição voltar com erro deve setar os erros corretamente" do
			fixture = read_fixture('service/response/rj/rio_de_janeiro/v1/consulta_situacao_lote_rps/fault.xml')
